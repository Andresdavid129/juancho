function consulta_general() {
    ...
    const visualizar = (data) => {
        ...
        info" onclick="location.href = 'edit.html?variable1=${data.baul[i].id_baul}'"> <img src='editar.png' height ='30' width='30'/></button>
       <button type='button' class="btn btn-warning" onclick="eliminar(${data.baul[i].id_baul})"> <img src='eliminar.png' height ='30'width='30'/></button></tr>`
        }
